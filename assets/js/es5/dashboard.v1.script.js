...
$(document).ready(function () {
    ...
    if (echartElemPie) {
        ...
        echartPie.setOption({
            color: ['#1ba1a1', '#10bcbc', '#00d3d3', '#288787', '#00d3d3', '#10bcbc'],
            tooltip: {
                show: true,
                backgroundColor: 'rgba(0, 0, 0, .8)'
            },
            ...
            series: [{
                ...
                radius: '60%',
                center: ['50%', '50%'],
                data: [{ value: 535, name: 'Rivers' }, { value: 310, name: 'Kano' }, { value: 234, name: 'Abuja' }, { value: 155, name: 'Lagos' }, { value: 130, name: 'Delta' }, { value: 348, name: 'Jos' }],
                itemStyle: {
                    emphasis: {
                        shadowBlur: 10,
                        shadowOffsetX: 0,
